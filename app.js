...
cameraTrigger.onclick = function() {     					/*hier hohelen wir uns ein Frame aus dem Video herraus über den Button*/
    cameraSensor.width = cameraView.videoWidth;					/*Daten von video in convas*/
    cameraSensor.height = cameraView.videoHeight;				/*Daten von video in convas*/
    cameraSensor.getContext("2d").drawImage(cameraView, 0, 0);			/*Daten von video in convas*/
    cameraOutput.src = cameraSensor.toDataURL("image/webp");			/*Datei in Optputelement speichern*/
